...
public class ArmConstants {
  ...
  public static final TunableNumber kTolerance = new TunableNumber("Arm: Tolerance", 500, TUNING_MODE);
  public static final TunableNumber kVTolerance = new TunableNumber("Arm: Velocity Tolerance", 50, TUNING_MODE);
}
